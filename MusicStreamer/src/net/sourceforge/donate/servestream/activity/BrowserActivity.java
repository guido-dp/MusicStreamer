...
import net.sourceforge.donate.servestream.activity.SettingsActivity;
import net.sourceforge.donate.servestream.activity.URLListActivity;
import net.sourceforge.donate.servestream.dbutils.Stream;
import net.sourceforge.donate.servestream.dbutils.StreamDatabase;
import net.sourceforge.donate.servestream.filemanager.*;
