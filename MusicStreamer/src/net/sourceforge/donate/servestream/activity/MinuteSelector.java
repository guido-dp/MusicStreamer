...
import net.sourceforge.donate.servestream.button.VerticalTextSpinner;
...
public class MinuteSelector extends Activity implements ServiceConnection
{
    ...
    private static final String STATE_SELECTED_POS = "net.sourceforge.donate.servestream.selectedpos";
