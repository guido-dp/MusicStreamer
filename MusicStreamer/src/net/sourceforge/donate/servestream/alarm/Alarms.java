...
package net.sourceforge.donate.servestream.alarm;
...
import net.sourceforge.donate.servestream.activity.AlarmClockActivity;
...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "net.sourceforge.donate.servestream.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "net.sourceforge.donate.servestream.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "net.sourceforge.donate.servestream.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "net.sourceforge.donate.servestream.ALARM_DISMISS";

    // This is a private action used by the AlarmKlaxon to update the UI to
    // show the alarm has been killed.
    public static final String ALARM_KILLED = "net.sourceforge.donate.servestream.ALARM_KILLED";

    // Extra in the ALARM_KILLED intent to indicate to the user how long the
    // alarm played before being killed.
    public static final String ALARM_KILLED_TIMEOUT = "net.sourceforge.donate.servestream.ALARM_KILLED_TIMEOUT";
    ...
    // snooze alert.
    public static final String CANCEL_SNOOZE = "net.sourceforge.donate.servestream.CANCEL_SNOOZE";
