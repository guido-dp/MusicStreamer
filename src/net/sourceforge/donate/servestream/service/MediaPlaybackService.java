...
import net.sourceforge.donate.servestream.activity.MediaPlaybackActivity;
import net.sourceforge.donate.servestream.dbutils.StreamDatabase;
import net.sourceforge.donate.servestream.metadata.SHOUTcastMetadata;
import net.sourceforge.donate.servestream.player.MultiPlayer;
import net.sourceforge.donate.servestream.provider.Media;
import net.sourceforge.donate.servestream.utils.MetadataRetriever;
import net.sourceforge.donate.servestream.utils.PreferenceConstants;
import net.sourceforge.donate.servestream.utils.Utils;
import net.sourceforge.donate.servestream.widget.ServeStreamAppWidgetOneProvider;
...
public class MediaPlaybackService extends Service implements OnSharedPreferenceChangeListener {
    ...
    public static final String PLAYSTATE_CHANGED = "net.sourceforge.donate.servestream.playstatechanged";
    public static final String META_CHANGED = "net.sourceforge.donate.servestream.metachanged";
    public static final String QUEUE_CHANGED = "net.sourceforge.donate.servestream.queuechanged";
    
    public static final String PLAYBACK_STARTED = "net.sourceforge.donate.servestream.playbackstarted";
    public static final String PLAYBACK_COMPLETE = "net.sourceforge.donate.servestream.playbackcomplete";
    public static final String START_DIALOG = "net.sourceforge.donate.servestream.startdialog";
    public static final String STOP_DIALOG = "net.sourceforge.donate.servestream.stopdialog";
    public static final String PLAYER_CLOSED = "net.sourceforge.donate.servestream.playerclosed";
    public static final String PREPARE_VIDEO = "net.sourceforge.donate.servestream.preparevideo";    
    
    public static final String SERVICECMD = "net.sourceforge.donate.servestream.MediaPlaybackServicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "net.sourceforge.donate.servestream.MediaPlaybackServicecommand.togglepause";
    public static final String PAUSE_ACTION = "net.sourceforge.donate.servestream.MediaPlaybackServicecommand.pause";
    public static final String NEXT_ACTION = "net.sourceforge.donate.servestream.MediaPlaybackServicecommand.next";
