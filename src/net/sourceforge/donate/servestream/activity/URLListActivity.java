...
import net.sourceforge.donate.servestream.utils.MusicUtils;
import net.sourceforge.donate.servestream.utils.MusicUtils.ServiceToken;

import net.sourceforge.donate.servestream.R;
import net.sourceforge.donate.servestream.alarm.Alarm;
...
import net.sourceforge.donate.servestream.utils.URLUtils;
import net.sourceforge.donate.servestream.utils.UpdateHelper;
...
public class URLListActivity extends ListActivity implements ServiceConnection {
    ...
    private static final String STATE_DETERMINE_INTENT_IN_PROGRESS = "net.sourceforge.donate.servestream.inprogress";
    private static final String STATE_DETERMINE_INTENT_STREAM = "net.sourceforge.donate.servestream.stream";
    private static final String STATE_MAKING_SHORTCUT = "net.sourceforge.donate.servestream.makingshortcut";
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			public synchronized void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (mMakingShortcut) {
					...
					contents.setType("net.sourceforge.donate.servestream/" + mRequestedStream.getUri());
	...
	private void handleIntentData() {
		...
		if ((contentType = intent.getType()) != null) {
			if (contentType.contains("net.sourceforge.donate.servestream/")) {
				intentUri = intent.getType().toString().replace("net.sourceforge.donate.servestream/", "");
				try {
